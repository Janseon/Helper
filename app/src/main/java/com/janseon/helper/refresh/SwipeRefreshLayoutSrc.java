 ...
 * </p>
 */
public class SwipeRefreshLayoutSrc extends android.support.v4.widget.SwipeRefreshLayout {
	 ...
	 * @param context
	 */
	public SwipeRefreshLayoutSrc(Context context) {
		this(context, null);
	}
	 ...
	 * @param attrs
	 */
	public SwipeRefreshLayoutSrc(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void ensureTarget() {
		...
		if (mDistanceToTriggerSync == -1) {
			if (getParent() != null && ((View) getParent()).getHeight() > 0) {
				final DisplayMetrics metrics = getResources().getDisplayMetrics();
				mDistanceToTriggerSync = (int) Math.min(((View) getParent()).getHeight() * MAX_SWIPE_DISTANCE_FACTOR, REFRESH_TRIGGER_DISTANCE
						* metrics.density);
			}
		}
	}
